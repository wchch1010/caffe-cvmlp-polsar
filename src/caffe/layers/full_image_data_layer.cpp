...
#include "caffe/layers/full_image_data_layer.hpp"
...
FullImageDataLayer<Dtype>::~FullImageDataLayer<Dtype>() {
...
template <typename Dtype>
void FullImageDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void FullImageDataLayer<Dtype>::ShuffleImages() {
...
template <typename Dtype>
void FullImageDataLayer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
INSTANTIATE_CLASS(FullImageDataLayer);
REGISTER_LAYER_CLASS(FullImageData);
